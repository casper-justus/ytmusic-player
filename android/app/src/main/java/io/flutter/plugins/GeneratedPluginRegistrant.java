...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.ashishpipaliya.extractor.ExtractorPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin extractor, com.ashishpipaliya.extractor.ExtractorPlugin", e);
    }
    try {
